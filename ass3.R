...
ggplot(iris, aes(x = Sepal.Length, y = Petal.Length, color = Species)) +
  ...
  scale_color_manual(values = c("setosa" = "green", "versicolor" = "blue", "virginica" = "red")) +
  theme_minimal()
...
ggplot(txhousing_clean, aes(x = sales, y = volume)) +
  geom_point()
ggplot(txhousing_clean, aes(x = year, y = sales)) +
  geom_boxplot()
ggplot(txhousing_clean, aes(x = volume)) +
